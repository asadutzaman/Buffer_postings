...
class PagesController extends Controller
{
    ...
    public function data(Request $request)
    {
        ...
        $data = DB::table('buffer_postings')->paginate(10);
        $group=DB::Table('buffer_postings')->select('group_id')->distinct();
        $group = $group->get();
    ...
    public function group_id_data(Request $request){
        if($request->ajax()){
            ...
            return view('admin.show_data', compact('data'))->render();
        }
    }
